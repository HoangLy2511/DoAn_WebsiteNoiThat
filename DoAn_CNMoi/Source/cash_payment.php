        ...
        <div class="content">
            <form action="" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="in4_ord_id" value="<?php echo $in4_ord_id; ?>">
                </div>                
                <div class="form-group">
                    ...
                    switch($btn){
                        case 'THANH TOÁN ĐƠN HÀNG': {
                            ...
                            if($ipt_cus_name!='' && $ipt_ord_id!=''){
                                if($p->editData("INSERT INTO dondathang(madonhang,tongtien,hoten_kh,email,sdt,diachi,ghichu,thoigian_dathang,trangthai_dathang,trangthai_vanchuyen) 
                                VALUES ('$ipt_ord_id', '$ipt_ord_amount', '$ipt_cus_name', '$ipt_cus_email', '$ipt_cus_phone', '$ipt_cus_address', '$ipt_ord_desc', '$ipt_ord_time_order', 'THANH CONG', 'CHO VAN CHUYEN')")==1){
