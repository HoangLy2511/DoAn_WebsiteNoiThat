...
-- Thời gian đã tạo: Th10 03, 2022 lúc 09:11 AM
...
CREATE TABLE IF NOT EXISTS `dondathang` (
  ...
  `thoigian_dathang` datetime NOT NULL,
...
INSERT INTO `dondathang` (`madonhang`, `tongtien`, `hoten_kh`, `email`, `sdt`, `diachi`, `ghichu`, `thoigian_dathang`, `trangthai_dathang`, `trangthai_vanchuyen`) VALUES
('12312313', 10000, 'ten', 'mail', 'sdt', 'diachi', 'ghichu', '2022-11-18 15:55:22', 'THÀNH CÔNG', 'CHỜ VẬN CHUYỂN');
...
('BANH13', 'BỘ BÀN ĂN 4 GHẾ MANGO NÂU - BANH13', 'ms20.jpg', 3100000, 'Kích thước 3mx2m', 'Việt Nam', 'BANAN', 'NV01', 'KHOBANAN'),
